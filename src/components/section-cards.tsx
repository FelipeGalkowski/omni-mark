  ...
  return (
    ...
    *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-5
    dark:*:data-[slot=card]:bg-card">
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Canceladas (Qtd)</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            4.5%
          </CardTitle>
          <CardAction>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Canceladas (Valor)</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            4.5%
          </CardTitle>
          <CardAction>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Devolvidas (Qtd)</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            4.5%
          </CardTitle>
          <CardAction>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Devolvidas (Valor)</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            4.5%
          </CardTitle>
          <CardAction>
